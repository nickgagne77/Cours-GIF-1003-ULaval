/**
 * \file validationFormat.pp
 * \brief Fichier d'implémentation contenant les fonctions de validations de formats string
 * \author Nicolas Gagné
 * \version 0.1
 * \date 2022-10-22
 *
 * Fichier d'implémentation contenant les fonctions de validations de formats string
 */
...
namespace util
{
  ...
  /**
   * \brief Fonction permettant de valider le nom d'auteur fourni
   * \param[in] p_nom Le nom de l'auteur étant un string
  ...
  /**
   * \brief Fonction permettant de valider le code ISSN fourni
   * \param[in] p_issn Le code ISSN étant un string
   * \return un booléen indiquant si le code ISSN est valide ou non
   */
  bool
  ...
  /**
   * \brief Fonction permettant de valider le code ISBN fourni
   * \param[in] p_issn Le code ISBN étant un string
   * \return un booléen indiquant si le code ISBN est valide ou non
   */
  bool
